<?php
    ...
    $sql = "INSERT INTO excessoes (id_agenda,data_inicio,data_termino,hora_inicio,hora_termino,duracao,domingo,segunda,terca,quarta,quinta,sexta,sabado) VALUES ('$id_agenda','$data_inicio','$data_termino','$hora_inicio','$hora_termino','$duracao','$domingo','$segunda','$terca','$quarta','$quinta','$sexta','$sabado')";
    $mysqli->query($sql);
