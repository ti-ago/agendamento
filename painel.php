    ...
    <div id="modalRotina" class="modal">
        <div class="modal-content">
            ...
            <form id="formRotina" onsubmit="enviarFormulario(event, 'inserir_rotina.php')">
                ...
                <label>Intervalo entre Sessões <small>(min) — folga entre inicio de cada sessao</small></label>
                <input type="number" name="intervalo_sessoes" id="edit_intervalo_sessoes" value="0" min="0" style="width:100%; padding:8px; font-size:0.85rem; border:1px solid #bbb; border-radius:4px;">
